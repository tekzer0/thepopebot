...
async function generateJobTitle(jobDescription) {
  try {
    ...
    const response = await model.invoke([
      ['system', 'Generate a descriptive ~10 word title for this agent job. The title should clearly describe what the job will do. Return ONLY the title, nothing else. No quotes.'],
